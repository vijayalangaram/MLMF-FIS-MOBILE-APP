...
export class AddressListContainer extends React.PureComponent {
  ...
  dunzo_Point_DeliveryFlagCall = () => {
    ...
    this.setState(
      ...
      () => {
        ...
        let calulatedunzodeliveryAMT = dunzo_Point_DeliveryFlag
        ...
        this.setState({
          ...
          dunzo_Direct_Delivery_Amt: this.state.dunzo_Direct_Delivery_Amt,
        });
      }
    );
  ...
  setSelectedAddress = async (address) => {
    ...
    this.setState({ isPaymentLoading: true });
    // this.setState({ loader_Flag_dunzo_CallResponse: true });
  ...
  getPaymentOptionsAPI = () => {
    // let { loader_Flag_dunzo_CallResponse } = this.state;
  ...
  onSuccessPaymentList = (onSuccess) => {
    ...
    if (
      ...
      let findmenucount = [
        ...new Set(this.state.cartItems.map((item) => item.availability)),
      ];
