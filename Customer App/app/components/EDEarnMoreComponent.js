      ...
      <View>
        ...
        <View style={style.earningModal}>
          ...
          <EDRTLView style={style.referBody}>
            ...
            />
            <View style={style.valueStyle}>
              <Text style={style.numberIcon}>2</Text>
            </View>
          </EDRTLView>
          <EDRTLView style={{ justifyContent: "center" }}>
            <SvgXml
              xml={isRTLCheck() ? dotted_line_left : dotted_line_right}
              width={"90%"}
              height={getProportionalFontSize(50)}
              preserveAspectRatio="none"
            />
...
const style = StyleSheet.create({
  ...
  shareView: {
    ...
    width: "100%",
    paddingHorizontal: 5,
    paddingVertical: getProportionalFontSize(12),
  },
  clipboardView: {
  ...
  promoText: {
    fontFamily: EDFonts.semiBold,
    fontSize: getProportionalFontSize(16),
    margin: getProportionalFontSize(10),
    color: EDColors.black,
  },
  copyText: {
    marginHorizontal: 5,
